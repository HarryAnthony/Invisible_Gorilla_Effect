...
from source.ad_hoc_methods.ad_hoc_utils.bayesian_torch.layers import QuantizedConv2dReparameterization
from source.ad_hoc_methods.ad_hoc_utils.bayesian_torch.layers import QuantizedLinearReparameterization
