...
def evaluate(net, idloader, oodloader, use_cuda=True, noiseMagnitude = 0, temper = 1,criterion=nn.CrossEntropyLoss(),OOD_dict={},verbose=True,**kwargs):
    """
    ...
    OOD_dict['name'] = ['ODIN (T='+str(temper)+', noiseMagnitude='+str(noiseMagnitude)+')']
