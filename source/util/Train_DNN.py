...
class Train_DNN():
    ...
    def __init__(self, training_dict, **kwargs):
        ...
        self.num_classes = training_dict['num_classes']
    ...
    def calc_loss(self,outputs,targets,**kwargs):
        ...
        self.criterion.cuda()
        loss = self.criterion(outputs.cuda(), targets.cuda())
    ...
    def determine_accuracy(self,outputs,targets,threshold=0.5,**kwargs):
        """
